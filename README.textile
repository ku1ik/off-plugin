...
Grab it here: "off-netbeans-0.9.4.nbm":http://counter.sickill.net/?f=http://sickill.net/assets/off-netbeans-0.9.3.nbm (Netbeans version) or "off-jedit-0.9.4.1.nbm":http://counter.sickill.net/?f=http://sickill.net/assets/off-jedit-0.9.4.1.nbm (JEdit version). If you want to help or just look into sources they're on "github":http://github.com/sickill/off-plugin/tree/master .
